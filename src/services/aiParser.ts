...
const JSON_SCHEMA = {
  ...
  properties: {
    ...
    teamName: { type: 'string', description: 'Team name, e.g. The Wednesday Night Boys' },
...
export async function parseSmsWithGemini(
  ...
  if (!activeKey) {
    ...
    return {
      ...
      teamName: heuristic.teamName || 'The Wednesday Night Boys',
  ...
  return {
    ...
    teamName: parsed.teamName || 'The Wednesday Night Boys',
